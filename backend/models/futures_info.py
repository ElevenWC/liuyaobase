...
class FuturesInfo(SQLModel, table=True):
    __tablename__ = "futures_info"
    id: Optional[int] = Field(default=None, primary_key=True)
    futures_code: str = Field(max_length=20, unique=True)
    futures_name: str = Field(max_length=50)
    exchange: Optional[str] = Field(default=None, max_length=20)
    night_session: Optional[str] = Field(default=None, max_length=10)
